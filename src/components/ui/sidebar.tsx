      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            style={style}
            className={cn(
              "group/sidebar-wrapper flex min-h-svh w-dvw has-[[data-variant=inset]]:bg-sidebar",
              className
            )}
            ref={ref}
            {...props}
  ...
  (
    ...
    if (collapsible === "none") {
      return (
        <div
          className={cn(
            "flex h-full w-[19rem] flex-col bg-sidebar text-sidebar-foreground",
            className
          )}
          ref={ref}
          {...props}
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "relative w-[19rem] bg-transparent transition-[width] duration-300 ease-[cubic-bezier(0.22,1,0.36,1)]",
        ...
        <div
          className={cn(
            "fixed inset-y-0 z-10 hidden h-svh w-[19rem] will-change-transform transition-[transform,width,box-shadow] duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] md:flex",
            side === "left"
